...
async function loadTasks() {
  ...
  try {
    ...
    tasks.forEach(task => {
      ...
      } else if (daysKeptNum >= 181) {
        row.style.backgroundColor = '#c62828';
        row.style.color = 'white';
      } else if (daysKeptNum >= 91) {
        row.style.backgroundColor = '#6d4c41';
        row.style.color = 'white';
      } else if (daysKeptNum >= 61) {
        row.style.backgroundColor = '#1565c0';
        row.style.color = 'white';
      } else if (daysKeptNum >= 31) {
        row.style.backgroundColor = '#2e7d32';
        row.style.color = 'white';
      } else if (daysKeptNum >= 14) {
        row.style.backgroundColor = '#ef6c00';
        row.style.color = 'white';
      } else if (daysKeptNum >= 1) {
        row.style.backgroundColor = '#fdd835';
